...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (!$problem) { // If there weren't any problems...
		...
		// send the email
		$body = "Thank you, {$_POST['first_name']}, for registering with the JD Salinger fan club!";
...
<form action="register.php" method="post" class="form--inline">
	...
	size="20" value="<?php if (isset($_POST['first_name'])) { print htmlspecialchars(
	$_POST['first_name']); } ?>"></p>
	...
	size="20" value="<?php if (isset($_POST['password1'])) { print htmlspecialchars(
	$_POST['password1']); } ?>"></p>
	<p><label for="password2">Confirm Password:</label><input type="password" name="password2" 
	size="20" value="<?php if (isset($_POST['password2'])) { print htmlspecialchars($_POST['password2']); } 
	?>"></p>
